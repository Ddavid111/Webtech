function validateForm() {
    ...
    var duration = document.getElementById("seasons").value
    ...
    if (duration === '' || duration <= 0) {
        message += 'Seasons must be a positive number\n'
        isValid = false;
        document.getElementById('seasons').classList.add('error');
    } else {
        document.getElementById('seasons').classList.remove('error');
    }
